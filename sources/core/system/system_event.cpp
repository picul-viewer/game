...
void sys::system_event::set( )
{
	SetEvent( m_id );
}

void sys::system_event::reset( )
{
	ResetEvent( m_id );
}

void sys::system_event::wait( u32 const wait_ms )
{
	WaitForSingleObject( m_id, wait_ms );
}

void sys::system_event::wait_all( u32 const count, system_event* const objects, u32 const wait_ms )
{
	ASSERT( count != 0 );
...
u32 sys::system_event::wait_any( u32 const count, system_event* const objects, u32 const wait_ms )
{
	ASSERT( count != 0 );
