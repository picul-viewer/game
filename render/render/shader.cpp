...
{
	api::get_device( )->CreateInputLayout( in_descs, in_descs_count, in_data, in_size, &m_layout );
	api::get_device( )->CreateVertexShader( in_data, in_size, nullptr, &m_shader );
}
...
{
	api::get_context( )->IASetInputLayout( m_layout );
	api::get_context( )->VSSetShader( m_shader, nullptr, 0 );
}
...
{
	api::get_device( )->CreatePixelShader( in_data, in_size, nullptr, &m_shader );
}
...
{
	api::get_context( )->PSSetShader( m_shader, nullptr, 0 );
}
...
{
	api::get_device( )->CreateGeometryShader( in_data, in_size, nullptr, &m_shader );
}
...
{
	api::get_context( )->GSSetShader( m_shader, nullptr, 0 );
}
...
{
	api::get_device( )->CreateHullShader( in_data, in_size, nullptr, &m_shader );
}
...
{
	api::get_context( )->HSSetShader( m_shader, nullptr, 0 );
}
...
{
	api::get_device( )->CreateDomainShader( in_data, in_size, nullptr, &m_shader );
}
...
{
	api::get_context( )->DSSetShader( m_shader, nullptr, 0 );
}
...
{
	api::get_device( )->CreateComputeShader( in_data, in_size, nullptr, &m_shader );
}
...
{
	api::get_context( )->CSSetShader( m_shader, nullptr, 0 );
}
